...
const Contact: React.FC = () => {
  ...
  return (
    <div className="container pb-5" id="Contact">
      <h1 data-aos="fade-up"><em>{t("contactWithUs")}</em></h1>
      <h2 className="text-center" data-aos="fade-up" data-aos-delay="100">{t("helpBuildApp")}</h2>
        ...
        <div className="contact-form" data-aos="fade-up" data-aos-delay="200">
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="row mb-3">
              <div className="col">
                <label>{t("name")}</label>
                <input type="text" className="form-control text-light" placeholder={t("placeholderName")} />
              </div>
              <div className="col">
                <label>{t("email")}</label>
                <input type="email" className="form-control text-light" placeholder={t("placeholderEmail")} />
              </div>
            </div>
            <div className="row mb-3">
              <div className="col">
                <label>{t("phone")}</label>
                <input type="text" className="form-control text-light" placeholder={t("placeholderPhone")} />
              </div>
              <div className="col">
                <label>{t("subject")}</label>
                <input type="text" className="form-control text-light" placeholder={t("placeholderSubject")} />
              </div>
            </div>
            <div className="mb-3">
              <label>{t("message")}</label>
              <textarea className="form-control text-light" rows={3} placeholder={t("placeholderMessage")}></textarea>
            </div>
        ...
        <div className="contact-info" data-aos="fade-up" data-aos-delay="300">
          ...
          <div className="contact-info-item">
            ...
            <div>
              ...
              <a href="https://wa.me/201015762659" target="_blank" rel="noreferrer">
                +20 101 576 2659
              </a>
            </div>
          </div>
